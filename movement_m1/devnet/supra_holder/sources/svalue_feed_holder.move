module supra_holder::svalue_feed_holder {
    ...
    native public fun get_price(oracle_holder: address, pair: u32): (u128, u16, u128, u64);

    /// It will return the priceFeedData value for that multiple tradingPair
    native  public fun get_prices(oracle_holder: address, pairs: vector<u32>): vector<Price>;
    ...
    native public fun get_derived_price(oracle_holder: address, pair_id1: u32, pair_id2: u32, operation: u8): (u128, u16, u64, u8);
}
